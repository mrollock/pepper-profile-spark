...
import { DISCLAIMER_PAGE } from '@/data/legalCopy';
  ...
  return (
    <div className="min-h-screen bg-dark">
      <div className="mx-auto max-w-[680px] px-[clamp(1.25rem,5vw,3rem)] py-24">
        ...
        <h1 className="mb-8 font-display text-[clamp(1.8rem,4vw,2.4rem)] text-cream">Disclaimer</h1>

        <div className="space-y-6 font-body text-[0.95rem] leading-[1.75] text-cream-soft">
          <p>{DISCLAIMER_PAGE.institutionalSeparation}</p>
          <p>{DISCLAIMER_PAGE.credentialContext}</p>
          <p>{DISCLAIMER_PAGE.educationalNature}</p>
          <div className="pt-4">
