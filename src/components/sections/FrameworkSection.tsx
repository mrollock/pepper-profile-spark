...
import bajanPepperSauce from '@/assets/Bajan-Pepper-Sauce.jpg';

export function FrameworkSection() {
  return (
    <section className="bg-cream py-[var(--section-pad)] px-[clamp(1.25rem,5vw,3rem)]" id="framework">
      <div className="mx-auto max-w-[var(--content-max)]">
        {/* Two-column layout: image left, opening text right */}
        <div className="grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-8 md:gap-12 items-start">
          {/* Image column */}
          <RevealSection>
            <img
              src={bajanPepperSauce}
              alt="A bottle of golden Bajan pepper sauce with a small dish of sauce beside it"
              loading="lazy"
              className="w-full max-h-[400px] rounded-lg shadow-lg object-cover border border-gold/20"
            />
          </RevealSection>
