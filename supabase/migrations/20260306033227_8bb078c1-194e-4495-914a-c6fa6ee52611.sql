...
-- Allow public SELECT on quiz_submissions by ID (for results page)
CREATE POLICY "Allow select quiz_submissions by id"
ON public.quiz_submissions
FOR SELECT
USING (true);

-- Update trigger to pass the record ID to the email function
